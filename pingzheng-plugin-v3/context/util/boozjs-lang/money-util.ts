...
export function handleLimitInteger({moneyNumberic, limitInteger}) {
...
export function toMoneyInputStr(moneyStr, limitInteger, limitDecimal) {
...
export function toMoneyStr2(number) {
...
export function numbericCastMoneyStr(numberic) {
    const moneyNumberic = parseFloat(toMoney(numberic.toString()));
    return moneyNumberic.toFixed(2);
}

export function filterStrCastMoneyStr(str) {
