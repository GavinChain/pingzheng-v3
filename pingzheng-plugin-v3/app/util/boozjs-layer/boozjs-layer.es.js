...
layer.style = function(index, options, limit) {
  var layero = $("#" + doms[0] + index), contElem = layero.find(".layui-layer-content"), type = layero.attr("type"), titHeight = layero.find(doms[1]).outerHeight() || 0, btnHeight = layero.find("." + doms[6]).outerHeight() || 0;
  layero.attr("minLeft");
...
layer.photos = function(options, loop, key) {
  ...
  dict.tabimg = function(key2) {
    ...
    layer.close(dict.index);
    layer.photos(options, true, key2);
  };
  dict.event = function() {
